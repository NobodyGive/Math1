...
const EventsSection: React.FC = () => {
  ...
  const handleEventClick = (index: number) => {
    setClickedEvent(clickedEvent === index ? null : index);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event, index) => (
            <div 
              key={index} 
              className={`panel-rainbow-static p-6 cursor-pointer ${
                clickedEvent === index ? 'active' : ''
              }`}
              ...
              tabIndex={0}
              role="button"
              aria-label={`Click to ${clickedEvent === index ? 'deactivate' : 'activate'} rainbow mode for ${event.title}`}
            >
              ...
              {clickedEvent === index && (
                <div className="mt-4 text-center">
                  <span className="text-white text-sm font-bold bg-black bg-opacity-30 px-3 py-1 rounded-full">
                    ✨ Rainbow Mode Active! ✨
                  </span>
                </div>
              )}
...
const FormsSection: React.FC = () => {
  const [clickedForm, setClickedForm] = useState<number | null>(null);
  const forms = [
  ...
  const handleFormClick = (index: number) => {
    setClickedForm(clickedForm === index ? null : index);
  };
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {forms.map((form, index) => (
            <div 
              key={index} 
              className={`panel-rainbow-static p-8 cursor-pointer ${
                clickedForm === index ? 'active' : ''
              }`}
              ...
              tabIndex={0}
              role="button"
              aria-label={`Click to ${clickedForm === index ? 'deactivate' : 'activate'} rainbow mode for ${form.name}`}
            >
    ...
    <section id="join" className="py-20 px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form 
          ...
          tabIndex={0}
          role="button"
          aria-label={`Click to ${clickedJoin ? 'deactivate' : 'activate'} rainbow mode for join form`}
        >
...
const AboutSection: React.FC = () => {
  const leadership = [
    { name: "Alex Chen", role: "President", image: "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=300" },
    { name: "Maria Rodriguez", role: "Vice President", image: "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=300" },
    { name: "David Kim", role: "Secretary", image: "https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=300" },
    { name: "Sarah Johnson", role: "Treasurer", image: "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=300" }
  ];
